...
HOST = "Loco81"
ROWS = [
    ("Now",        "Working on Comizo project + my soldiery project"),
    ("Prev",       "Front-end work, UI design, small product builds"),
    ("Stack",      "Flutter · Python · JavaScript · Html · Css"),
    ("Highlights", "Design-to-code handoff, smart contracts, Cross-Platform apps"),
    ("Learning",   "Everything, but mostly Front-end and UI"),
    ("Reach",      "Loco81.ir"),
]
# ------------------------------------------------------------------------------
